...
import com.nupiboys.projectpower.client.screen.widget.TextField;
...
public class ContainerScreenBase<C extends Container> extends ContainerScreen<C> {
    public static final ResourceLocation DEFAULT_BACKGROUND = new ResourceLocation(ProjectPower.MOD_ID, "textures/gui/container/background.png");
