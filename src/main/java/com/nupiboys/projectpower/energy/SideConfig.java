...
import static com.nupiboys.projectpower.energy.SideConfig.Type.ALL;
import static com.nupiboys.projectpower.energy.SideConfig.Type.OFF;
...
public class SideConfig {
    ...
    public enum Type {
        ...
        public String getDisplayName() {
            return TextFormatting.GRAY + I18n.format("info.projectpower.side.config." + name().toLowerCase(), this.color);
        }
    }
}
